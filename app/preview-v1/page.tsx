...
export const metadata: Metadata = {
  title: "KD Genetics — Preview v1 (archive)",
  description:
    "Archive of the earlier preview homepage. Kept for reference while building the new version at /preview.",
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#F6F4EF] text-[#1E1E1E]">
      <Nav activePage="home" homeHref="/preview-v1" />
