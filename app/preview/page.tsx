        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <SlideshowGallery
            slides={[
              ...
              { src: "/farm-veg.jpg",            alt: "Cannabis plants in flower in the greenhouse",      caption: "Harvest time" },
              { src: "/sun-grown.jpg",           alt: "Sun-grown cannabis canopy on the farm",            caption: "Greenhouse" },
              { src: "/farm-chicken.jpg",        alt: "A hen on her nest at the farm",                    caption: "Ganjachicken" },
              { src: "/farm-cat.jpg",            alt: "The farm cat resting on a wall",                   caption: "Bobby" },
              { src: "/apparel-dog.jpg",         alt: "The farm dog in the shop with Kevin",              caption: "Mee", objectPosition: "center bottom" },
              { src: "/farm-shoot-01.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "Mila" },
              { src: "/farm-shoot-02.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "Willy" },
              { src: "/farm-shoot-03.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "Peter" },
              { src: "/farm-shoot-04.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "Organic fertiliser from BioBizz" },
              { src: "/farm-shoot-05.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "Papa KD mural behind the chill area" },
              { src: "/farm-shoot-06.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "KD shop" },
              { src: "/farm-shoot-07.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "Wall of Fame" },
              { src: "/farm-shoot-08.jpg",       alt: "Papa KD on the farm",                              caption: "Legend lighting it up", objectFit: "contain" },
              { src: "/farm-shoot-09.jpg",       alt: "KD Genetics farm, Tanote Bay",                     caption: "Water is life" },
            ]}
          />
        </div>
      </section>
