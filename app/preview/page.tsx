        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="text-center mb-16 space-y-3 max-w-xl mx-auto">
            ...
            <h3 className="font-display text-3xl md:text-4xl text-[#1E1E1E] leading-tight">
              The farm, stop by stop.
            </h3>
            <p className="text-[#6B6B6B]/80 text-sm md:text-base font-light">
              From the shop to the harvest terrace — what each space looks like, in order.
            </p>
          </div>
          ...
          <div className="space-y-20 md:space-y-24">
            ...
            <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
              ...
              <div className="md:col-span-5 space-y-3">
                <span className="text-[#5A6A4F]/70 text-xs font-medium uppercase tracking-[0.25em]">
                  Stop 01
                </span>
                <h4 className="font-display text-2xl md:text-3xl text-[#1E1E1E] leading-tight">
                  The Shop
                </h4>
